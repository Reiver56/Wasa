...
// It decodes the JSON from the request body into a User object,
// validates the user ID, checks if the user exists in the database,
// and either returns the existing user or creates a new user.
// Finally, it encodes the user information into the response body.
