...
//  Fuction that make a new folder for the user
func createFolder(ide string, ctx.reqcontext.RequestContext) error{
	path := filepath.Join("photos/", id)
	
	err := os.MkdirAll("./photos/"+id, 0777)
	if err != nil {
		return err
	}
	return nil
