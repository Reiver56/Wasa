...
/*
doLogin handles the login request and creates a new user if it doesn't exist.It decodes the JSON from the request body into a User object and validates the user ID.
