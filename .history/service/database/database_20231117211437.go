...
type AppDatabase interface {
	...
	SetNewUsername(usserID string, username string) error
...
func New(db *sql.DB) (AppDatabase, error) {
	...
	if tableName != 6 {
		...
		insertUser, err := db.Prepare(`INSERT INTO users(id, nickname) VALUES("ciao", "ciao")`)
		statement, err := insertUser.Exec()
	}
