...
package database
 ...
 This file contains the SQL queries to create the tables for the application's database. The tables include users, profile, and photo, each with their respective columns.
