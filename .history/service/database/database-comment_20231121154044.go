...
func (db *appdbimpl) PutComment(id_photo int64, id_user string, ) (int64, error) {
	
	res, err := db.c.Exec(`INSERT INTO comments(id_photo, id_user, comment) VALUES(?, ?, ?)`, c.ID_photo, c.ID_user, c.)
	if err != nil {
		return -1,err
	}
