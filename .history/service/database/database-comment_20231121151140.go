...
func (db *appdbimpl) UploadComment(c Comment) (int64, error) {
	
	res, err := db.c.Exec(`INSERT INTO comments(id_photo, id_user, comment) VALUES(?, ?, ?)`, c.ID_photo, c.ID_user, c.Comment)
	if err != nil {
		return -1,err
	}
