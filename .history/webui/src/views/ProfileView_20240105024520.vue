		...
		<div class="list-of-users" v-if="showList === true" aria-hidden="true" tabindex="-1">
			...
			<div class="list-of-users-container">
				...
				<div class="list-of-users-header">
					<button v-if="isBannedList" @click="getBans"><font-awesome-icon :icon="['far', 'arrow-left']" /></button>
					<button v-else @click="freeLists"><font-awesome-icon :icon="['far', 'arrow-left']" /></button>
					<span>{{header}}</span>
