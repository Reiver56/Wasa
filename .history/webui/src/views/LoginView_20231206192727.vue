<template>
	...
	<div class="login-form">
		...
		<div class="input-d">
			<input :on-submit="doLogin" type="text" name="user_id-form" spellcheck="false" v-model="user_id" maxlength="13"/>
		</div>
		<div class="input-d">
			<input :on-submit="doLogin" type="text" name="nickname-form" spellcheck="false" v-model="nickname" maxlength="13"/></div>
			<div class="button-d">
