<template>
	...
	<div class = "top-container-profile">
		...
		<input :readonly="!isOwner" v-model="nickname" @input="editingNickname" @focusout="saveChangeNickname" class="top-body-profile-user-nickname" maxlength="16" spellcheck="">
	</div>
