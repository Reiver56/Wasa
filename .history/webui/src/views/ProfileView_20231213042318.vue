<template>
	...
	<div class = "top-container-profile">
		...
		<UploadPhoto v-if="showUploadPhoto" :photoType="'post'" @exit-form="showUploadPhoto = false" @refresh-data="$router.go(0)"  @show-form="showUploadPhoto = true" @error="(value)=> {errorMsg = value}"/>
