<template>
	...
	<div class = "top-container-profile">
		...
		<div class="list-of-users "  aria-hidden="true" tabindex="-1">



			<div class="modal fade modal-dialog modal-dialog-centered modal-dialog-scrollable list-of-users-container" v-if="showList === true">
