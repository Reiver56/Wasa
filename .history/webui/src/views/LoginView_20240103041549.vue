...
<template>
	...
	<div class="login-container">
		<img src="../assets/logo/logo_blue 1.png" alt="logo" width="500" height="500">
		<div class="top-login-container"> <span class="login-title">Login</span></div>
		<div class="bottom-login-container">
			<div class="login-input-container">
				<input :on-submit="doLogin" type="text" name="nickname-form" spellcheck="false" v-model="nickname" maxlength="16" placeholder="nickname">
			</div>
...
.form-container-login input:focus{
    outline-color: #03C988;
}

.form-text-container-login{
    font-size: 1em;
    font-weight: 400;
    color: rgb(0,0,0,0.6);
}
...
.bottom-login-container button{
    ...
    border: 0px solid #00754e;
    border-radius: 7px;

    color: rgb(0,0,0,0.8);
}

.bottom-login-container button:hover{
    background-color: #00ad73;
}


.form-text-container-login-error{
