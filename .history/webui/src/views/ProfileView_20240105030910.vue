<template>
	...
	<div class = "top-container-profile">
		...
		<div class="modal my-modal-disp-none" v-if="showList === true" aria-hidden="true" tabindex="-1">
			<div class="modal modal-dialog modal-dialog-centered  list-of-users-container">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title fs-5">List of Users</h5>
