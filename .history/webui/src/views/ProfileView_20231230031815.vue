<template>
	...
	<div class = "top-container-profile">
		...
		<div class="top-body-profile-user-follow">
			<button v-if="!isOwner" class="top-body-profile-user-follow-button" @click="follow()">{{ isFollowed  ? "Unfollow" : "Follow" }}</button>
		</div>
	...
	methods: {
		...
		getProfile: async function() {
			...
			try{
				...
				this.isFollowed = response.data.followers != null ? response.data.followers.find(obj => obj.user_id === localStorage.UserID) : false;
