<template>
	...
	<div class = "top-container-profile">
		...
		<div class="modal fade modal-dialog modal-dialog-centered modal-dialog-scrollable list-of-users-none" v-if="showList === true">


			<div class="modal-dialog">
				
				<button @click="freeLists"><font-awesome-icon :icon="['far', 'times-circle']" /></button>
