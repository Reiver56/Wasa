<template>
	...
	<div class = "top-container-profile">
		<div class="top-body-profile-container">
			<button class="btn arraw-left" @click="$router.push('/home')">
				<font-awesome-icon icon="fa-solid fa-arrow-left" />
			</button>
			<button class="btn option-button" @click="options=true" @focusout="closeOption">
		...
		<div class="top-body-profile-user-info">
			<div class="top-body-profile-user-info-item" >
				<button class="btn get-follow-button ms-2 d-flex align-items-center" @click="getFollowers">
			...
			<div class="top-body-profile-user-info-item" @click="getFollowing">
				<button  class="btn get-follow-button ms-2 d-flex align-items-center" @click="getFollowing">
		...
		<div class="list-of-users " v-if="showList === true" aria-hidden="true" tabindex="-1">
			...
			<div class="modal fade modal-dialog modal-dialog-centered modal-dialog-scrollable list-of-users-container">
				<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable list-of-users-header">
					<button @click="freeLists" class="btn close-btn"><font-awesome-icon :icon="['far', 'times-circle']" /></button>
					<h1 class="modal-title fs-5" :id="modal_id">{{header}}</h1>
				</div>
				<button @click="freeLists" class="btn close-btn"><font-awesome-icon :icon="['far', 'times-circle']" /></button>
