<template>
	...
	<div class = "top-container-profile">
		<div class="top-body-profile-container">
			// make button for return to home page
			<button class="top-body-profile-user-img" @click="getMyProfile">
				<img :src="`data:image/jpeg;base64,${this.image64}`" class="top-body-profile-user-img-img">
