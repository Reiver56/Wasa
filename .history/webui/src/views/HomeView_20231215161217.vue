<template>
	<div>
		<UploadPhoto v-if="showUploadPhoto" @exit-form="showUploadPhoto = false" @refresh-data="getMyStream" @error="errorMsg = $event" />
		<NavBar @show-upload-form="showUploadPhoto=true" @error-occurred="(value) => { errorMsg }"/>
