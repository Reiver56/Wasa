<template>
	...
	<div class = "top-container-profile">
		...
		<button class="upload-post-button" @click="$emit('show-form')" @show-form="showUploadPhoto = true" @error="(value)=> {errorMsg = value}">
            <font-awesome-icon icon="fa-regular fa-square-plus" />
        </button>
		<UploadPhoto v-if="showUploadPhoto" :photoType="'post'" @exit-form="showUploadPhoto = false" @refresh-data="$router.go(0)" @error="(value) => {errorMsg = value}"/>
