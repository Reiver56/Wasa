	...
	<div class = "top-container-profile">
		...
		<div class="top-body-profile-user-info">
			<div class="top-body-profile-user-info-item" >
				<button class="get-follow-button" @click="getFollowers" data-bs-toggle="modal">
		...
		<div class="modal fade modal-dialog modal-dialog-centered modal-dialog-scrollable list-of-users" v-if="showList === true"  tabindex="-1" aria-hidden="true">
