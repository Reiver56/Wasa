				...
				<div class="user-body">
					<div class="container">
						<div class="d-flex flex-row justify-content-end align-items-center mb-2">
							...
							<button class="my-trnsp-btn-heart" @click="toggleLike" data-bs-toggle="modal">
								<font-awesome-icon icon="fa-regular fa-heart me-1" />
                                    {{Likes.length}}
                            </button>
							<button class="my-trnsp-btn-comment" @click="commentClick" :data-bs-target="'#comment_model'+photo_id">
