...
<template>
	<div class="photo-container">
		...
		/>
		<div class="photo-container d-flex flex-row justify-content-center">
				...
				<div class="user-body">
					<div class="container">
						<div class="d-flex flex-row justify-content-end align-items-center mb-2">
							...
							<button class="my-trnsp-btn-comment m-0 p-1 d-flex justify-content-center align-items-center"
