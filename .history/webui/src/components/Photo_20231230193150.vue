				...
				<div class="user-body">
					<div class="container">
						<div class="d-flex flex-row justify-content-end align-items-center mb-2">
							...
							<button data-bs-toggle="modal" :data-bs-target="'#like_modal'+photo_id" class="counter-of-like-color m-0 p-1 d-flex justify-content-center align-items-center">{{Likes.length}}</button>
							<button class="my-trnsp-btn m-0 p-1 d-flex justify-content-center align-items-center" @click="commentClick" data-bs-toggle="modal" :data-bs-target="'#comment_modal'+photo_id">
