<template>
	<div class="edit-post-container">
		<cropper class="cropper" :image="image64" :auto-zoom="true" ref="cropper" :stencil-component="cropperProps.stencilComponent" :stencil-size="cropperProps.stencilSize"
		...
		<div class="button-container">
            <button class="cancel-button" @click="$emit('exit-form')">Cancel</button>
...
export default {
	...
	data() {
		return {
			...
			cropperProps: {
				...
				stencilComponent: new RegExp("profile").test(this.editorType) ? markRaw(CircleStencil) : markRaw(RectangleStencil),
	...
	methods: {
		saveEdit() {
			const canvas = this.$refs.cropper.crop();
