...
export default{
	...
	data(){
		return {
			ownerID: this.postData.ownerID['userID'],
			ownerName: this.postData.ownerID['nickname'],

			// Photo data
			photoID: this.postData.photoID,
			isLikes: this.postData.liked,
	...
	mounted(){
		if (this.ownerID == localStorage.user)
	}
}
</script>
<template>
