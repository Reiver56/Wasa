				...
				<div class="user-body">
					<div class="container">
						<div class="d-flex flex-row justify-content-end align-items-center mb-2">
							...
							<button class="my-trnsp-btn-heart m-0 p-1 d-flex justify-content-center align-items " @click="toggleLike" >
								<i @click="toggleLike"><font-awesome-icon icon="fa-regular fa-heart me-1" /></i>
								<i data-bs-toggle="modal" :data-bs-target="'#like_modal'+photo_id" class="my-comment-color">{{Likes.length}}</i>
                            </button>
							<button class="my-trnsp-btn-comment" @click="commentClick" data-bs-toggle="modal" :data-bs-target="'#comment_modal'+photo_id">
