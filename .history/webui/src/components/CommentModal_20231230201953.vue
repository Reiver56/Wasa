					...
					<div class="row w-100">
						<div class="col-10">
							<div class="mb-3 me-auto">
								<textarea class="form-control" id="exampleFormTextArea" rows="1"
								placeholder="Add a comment..." maxlength="30" v-model="commentText"></textarea>
							</div>
						</div>
						<div class="col-2 d-flex align-items-center">
							<button type="button" class="btn btn-primary"
							@click.prevent="postComment"
							:disabled="commentText.length < 1 || commentText.length > 30">Post</button>
						</div>
					</div>
				</div>
			</div>
